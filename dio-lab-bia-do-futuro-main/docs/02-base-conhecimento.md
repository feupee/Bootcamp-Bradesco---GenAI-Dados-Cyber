...
Existem duas possibilidades, injetar os dados diretamente no prompt (Ctrl + C, Ctrl + V) ou carregar os arquivos via código, como abaixo:
...
#JSONs
with open('data/perfil_investidor.json', 'r', endoding='utf-8') as f:
  perfil = json.load(f)

with open('data/produtos_financeiros.json', 'r', endoding='utf-8') as f:
...
[
  ...
  },
  {
    ...
    "categoria": "fundo",
    "risco": "medio",
    "rentabilidade": "Dividen Yield (DY) costuma ficar entre 6% a 12% ao ano",
    "aporte_minimo": 100.00,
